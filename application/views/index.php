...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="<?php echo base_url() ?>images/img_2.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="<?php echo base_url() ?>images/img_1.jpg" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="<?php echo base_url() ?>images/img_3.jpg" alt="Image" class="img-fluid">
              <div class="unit-1-text">
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(<?php echo base_url() ?>images/hero_bg_2.jpg); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
      ...
      <div class="container">
        ...
        <div class="row mb-3 align-items-stretch">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              <img src="<?php echo base_url() ?>images/hero_bg_1.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              <img src="<?php echo base_url() ?>images/hero_bg_2.jpg" alt="Image" class="img-fluid">
              <h2 class="font-size-regular"><a href="#">How to Plan Your Vacation</a></h2>
              <div class="meta mb-4">by Theresa Winston <span class="mx-2">&bullet;</span> Jan 18, 2019 at 2:00 pm <span class="mx-2">&bullet;</span> <a href="#">News</a></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
            </div>
